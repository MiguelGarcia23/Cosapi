...
export const BannerInstallation: FC = () => {
    ...
    return (
        ...
        <Box className={ styles['installation-banner'] }>
            ...
            <Typography variant='h2' color='info.main' className={ styles['title-installation-banner'] }>
