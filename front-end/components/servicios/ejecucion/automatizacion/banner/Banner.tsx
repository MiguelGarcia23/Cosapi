...
export const BannerAutomation: FC = () => {
    ...
    return (
        ...
        <Box className={ styles['automation-banner'] }>
            ...
            <Typography variant='h2' color='info.main' className={ styles['title-automation-banner'] }>
                Automatización de equipos y sistemas
            </Typography>
