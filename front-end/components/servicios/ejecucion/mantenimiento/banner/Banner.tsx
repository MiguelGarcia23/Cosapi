...
export const BannerMaintenance: FC = () => {
    ...
    return (
        ...
        <Box className={ styles['maintenance-banner'] }>
            ...
            <Typography variant='h2' color='info.main' className={ styles['title-maintenance-banner'] }>
